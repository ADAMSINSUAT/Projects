            ...
            <>
                <Card sx={{ mt: 2, border:1, borderColor:"black", borderRadius:1 }}>
                    <div style={{ position: "relative" }}>
                        ...
                        <Typography textAlign="left" style={{ fontSize: 32, fontFamily: "sans-serif", position: "absolute", color: "white", top: "50%", left: "35%", transform: "translateX(-50%)", }}>"Band is a multidisciplinary creative studio based in the Pacific Northwest.
